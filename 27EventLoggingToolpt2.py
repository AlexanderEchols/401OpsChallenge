#!/usr/bin/python3
# Script: Ops 401 Class 27 Ops Challenges: 
# Author: Alexander Echols.    
# Date of creation: 23 May 2023                
...
def alsLogger():
    ...
    # Rotating file handler & log rotation settings
    fileHandler = RotatingFileHandler(logFile, maxBytes=maxFileSize, backupCount=backCount)
