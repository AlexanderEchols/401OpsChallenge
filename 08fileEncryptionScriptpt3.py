#!/bin/python3
# Script: Ops 401 Class 08 Ops Challenges: 
# Author: Alexander Echols.    
# Date of creation: 25 April 2023                
# Date of latest revision: 25 April 2023.      
# Purpose: update the previous script to have two new functions
...
# Function to alter the desktop wallpaper on a Windows PC with a ransomware message


# Function to create a popup window on a Windows PC with a ransomware messag
